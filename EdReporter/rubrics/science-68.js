...
window.rubrics['science-68'] = {
    id: 'science-68',
    name: 'NGSS 6-8 Science Rubric (EdReports v2.0)',
    description: 'EdReports 2.0 NGSS Grades 6-8 Science Evaluation Rubric',
    metadataFields: [
    ...
    gateways: [
        {
            ...
            totalPoints: 34,
            ratingThresholds: { meets: 28, partially: 17 }, // Updated to match PDF: 14+15 = 29. Let's use the provided scoring. 14+9 = 23... Scoring is 14-16 for ME and 9-14 for ME... Let's use the PDF total. G1.1 = 16, G1.2 = 18. Total = 34. G1.1 ME = 14-16. G1.2 ME = 15-18. ME for gateway would be 14+15=29? The rubric PDF says G1 ME is 28-34, PME is 17-27. Let's trust the provided rubric object.
            criterionSections: [
                {
                    id: 'criterion1_1',
                    name: 'Criterion 1.1: Phenomena and Problems Drive Learning (16 points)',
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                purpose: "This indicator examines the materials to determine whether phenomena and/or problems in the course are presented in a direct manner to students. It examines the materials for a common experience for all students from which knowledge can be built; it does not assume that all students have background knowledge and experience.",
                ...
                {
                    id: 'criterion1_2',
                    name: 'Criterion 1.2: Three-Dimensional Learning and Assessment (18 points)',
                             ...
                             evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        ...
                                        "Determine how many elements of the learning objectives are addressed in the assessments.\n- Consider all formative assessments within each sequence associated with a set of learning objectives.",
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        ...
                                        "Determine what standards are measured by each assessment.\n- Individual SEPs, DCIs, or CCCs may individually be present in each of the various components of an assessment within the summative process.",
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        ...
                                        "Describe when and how the assessments provide students the opportunity to apply their learning to an uncertain phenomenon or problem.\n- An uncertain phenomenon or problem can consist of a completely novel scenario or a new aspect of a phenomenon or problem students have already engaged with.",
                                        "Describe how elements of the three dimensions are used together in assessments and assessment questions.\n- In a set of questions related to the same scenario or phenomenon, the three dimensions may be present across the set. They do not need to all be present in a single question.\n- For a single question related to an isolated phenomenon or scenario, look for the presence of all three dimensions in the question.",
                                        "Do not consider assessment of standards outside of the grade-band.",
        ...
        },
        {
            ...
            totalPoints: 34,
            ratingThresholds: { meets: 29, partially: 17 },
            criterionSections: [
                {
                    id: 'criterion2_1',
                    name: 'Criterion 2.1: Coherence and Full Scope of the Three Dimensions (34 points)',
                    description: 'Materials are coherent in design, scientifically accurate, and support grade-band endpoints made for all three dimensions.',
                    totalPoints: 34,
                    items: [
                        {
                             ...
                             evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        "Determine where students develop grade-band understanding (PS, LS, ESS, ETS DCIs) of each of the DCI elements. Note if the element is fully met, partially met, or not met by the materials.",
                                ...
                                clusterMeeting: {
                                    questions: [
                                        "How many of the grade-band Physical, Life, Earth and Space, and Engineering, Technology, and Applications of Science DCI elements do the materials incorporate?"
                                    ]
                                }
                             },
                             items: [
								 {
									...
									scoringOptions: [0, 1, 2],
									scoringCriteria: [
										'Materials provide opportunities for students to fully learn and develop nearly all associated elements of the grade-band Physical Science DCIs.'
									],
									isNarrativeOnly: false,
                                    isNonNegotiable: false,
                                    evidenceGuide: {
                                        scoringDetails: [
                                            { score: 2, text: "Materials provide opportunities for students to fully learn and develop nearly all associated elements of the grade-band Physical Science DCIs." },
                                            { score: 1, text: "Materials provide opportunities for students to fully learn and develop most of the associated elements of the grade-band Physical Science DCIs." },
                                            { score: 0, text: "Materials do not provide opportunities for students to learn and develop numerous associated elements of the grade-band Physical Science DCIs." }
                                        ]
                                    }
								},
								{
									...
									scoringOptions: [0, 1, 2],
									scoringCriteria: [
										'Materials provide opportunities for students to fully learn and develop nearly all associated elements of the grade-band Life Science DCIs.'
									],
									isNarrativeOnly: false,
                                    isNonNegotiable: false,
                                    evidenceGuide: {
                                        scoringDetails: [
                                            { score: 2, text: "Materials provide opportunities for students to fully learn and develop nearly all associated elements of the grade-band Life Science DCIs." },
                                            { score: 1, text: "Materials provide opportunities for students to fully learn and develop most of the associated elements of the grade-band Life Science DCIs." },
                                            { score: 0, text: "Materials do not provide opportunities for students to learn and develop numerous associated elements of the grade-band Life Science DCIs." }
                                        ]
                                    }
								},
								{
									...
									scoringOptions: [0, 1, 2],
									scoringCriteria: [
										'Materials provide opportunities for students to fully learn and develop nearly all associated elements of the grade-band Earth and Space Science DCIs.'
									],
									isNarrativeOnly: false,
                                    isNonNegotiable: false,
                                    evidenceGuide: {
                                        scoringDetails: [
                                            { score: 2, text: "Materials provide opportunities for students to fully learn and develop nearly all associated elements of the grade-band Earth and Space Science DCIs." },
                                            { score: 1, text: "Materials provide opportunities for students to fully learn and develop most of the associated elements of the grade-band Earth and Space Science DCIs." },
                                            { score: 0, text: "Materials do not provide opportunities for students to learn and develop numerous associated elements of the grade-band Earth and Space Science DCIs." }
                                        ]
                                    }
								},
								{
									...
									scoringOptions: [0, 1, 2],
									scoringCriteria: [
										'Materials provide opportunities for students to fully learn and develop nearly all associated elements of the grade-band Engineering, Technology, and Applications of Science DCIs.'
									],
									isNarrativeOnly: false,
                                    isNonNegotiable: false,
                                    evidenceGuide: {
						...
						},
                        {
                            ...
                            scoringCriteria: [
                                'Materials provide opportunities for students to fully learn and develop all grade-band SEPs and nearly all associated grade-band elements.',
                                'Materials consistently provide multiple and repeated opportunities for students to use grade-band SEPs across various contexts.'
                            ],
                            isNarrativeOnly: false,
                            isNonNegotiable: false,
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        "Determine when and where students develop and use grade-band appropriate SEPs and their elements. Note if the element is fully met, partially met, or not met by the materials.",
                                        "Determine where the full SEP element is taught over the course of multiple learning opportunities, as applicable.",
                                ...
                                clusterMeeting: {
                                    questions: [
                                        ...
                                        "Do the materials provide repeated opportunities for students to use the grade-band SEPs across various contexts?",
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                purpose: "This indicator examines the materials to determine if the grade-band CCCs and their associated elements are included in the course. It also examines the materials to determine if multiple and repeated opportunities with the grade-band CCCs are provided and if CCCs from outside of the grade-band are included.",
                                researchConnection: "\"...[Crosscutting concepts] bridge disciplinary boundaries, having explanatory value throughout much of science and engineering. These crosscutting concepts were selected for their value across the sciences and in engineering. These concepts help provide students with an organizational framework for connecting knowledge from the various disciplines into a coherent and scientifically based view of the world.” (A Framework for K-12 Science Education, p. 83)\n\n\"Additionally, eight understandings with appropriate grade-level outcomes are included as extensions of the science and engineering practices and crosscutting concepts, not as a fourth dimension of standards.” (NGSS Appendix H, p. 1)",
                                scoringDetails: [
                        ...
                        {
                            id: '2d',
                            name: '2d. Materials present Disciplinary Core Ideas (DCIs), Science and Engineering Practices (SEPs), and Crosscutting Concepts (CCCs) in a way that is scientifically accurate. *NON-NEGOTIABLE*',
                            scoringOptions: [0, 1, 2],
                            scoringCriteria: [
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        ...
                                        "If errors are present, determine what type of error is present.\n- Major errors could lead to student misconceptions that would hinder learning in this grade-band or beyond, including generalizations that oversimplify content beyond making it accessible to the grade-level/band.\n- Minor errors could consist of typos or generalizations that include a presentation of a science topic that oversimplifies the content but would not lead to a major misconception by students and are appropriate for the grade-level/band."
                                    ]
                                },
                                clusterMeeting: {
                                    questions: [
                        ...
                        {
                            id: '2e',
                            name: '2e. Materials do not inappropriately include scientific content and ideas outside of the grade-band Disciplinary Core Ideas. *NON-NEGOTIABLE*',
                            scoringOptions: [0, 1, 2],
                            scoringCriteria: [
                            ...
                            evidenceGuide: {
                                ...
                                purpose: "This indicator examines whether materials inappropriately include non-scientific content or ideas (e.g., moral, societal, aesthetic, religious, existential) as science ideas. It also examines whether materials inappropriately include scientific content or ideas outside of the DCIs as DCIs in science, whether they inappropriately include DCIs from below the grade-band with no meaningful connections, and whether they inappropriately include content from beyond the grade-band DCIs with no meaningful connections.",
                                researchConnection: "\"Science is both a body of knowledge that represents current understanding of natural systems and the process whereby that body of knowledge has been established and is being continually extended, refined, and revised. Both elements are essential: one cannot make progress in science without an understanding of both. Likewise, in learning science one must come to understand both the body of knowledge and the process by which this knowledge is established, extended, refined, and revised.\" (Taking Science to School, p. 27)\n\n\"The continuing expansion of scientific knowledge makes it impossible to teach all the ideas related to a given discipline in exhaustive detail during the K-12 years. But given the cornucopia of information available today virtually at a touch- people live, after all, in an information age-an important role of science education is not to teach \"all the facts\" but rather to prepare students with sufficient core knowledge so that they can later acquire additional information on their own.\" (A Framework for K-12 Science Education, pp. 31-32)",
                                scoringDetails: [
                                    { score: 2, text: "Materials contain no instances where non-scientific content or ideas are included as science ideas. AND Materials contain few instances where scientific content or ideas are included without meaningful connections to grade-band DCIs. AND Materials contain no instances of DCIs from below the grade-band that are included without meaningful connections. AND Materials contain no instances of content from beyond the grade-band DCIs that are included without meaningful connections." },
                                    { score: 1, text: "Materials contain no instances where non-scientific content or ideas are included as science ideas. AND Materials contain few instances where scientific content or ideas are included without meaningful connections to grade-band DCIs. AND/OR Materials contain few instances of DCIs from below the grade-band that are inappropriately included. AND/OR Materials contain few instances of DCIs from beyond the grade-band that are inappropriately included." },
                                    { score: 0, text: "Materials contain multiple instances where non-scientific content or ideas are included as science ideas. OR Materials contain multiple instances where scientific content or ideas are included without meaningful connections to grade-band DCIs. OR Materials contain multiple instances of DCIs from below the grade-band that are inappropriately included. OR Materials contain multiple instances of DCIs from beyond the grade-band that are inappropriately included." }
                                ],
                                evidenceCollection: {
                                    locationsToReview: [
                                        "Review the learning sequences and learning opportunities in both student and teacher materials."
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                purpose: "This indicator examines the materials to determine if NGSS Connections to Nature of Science and Engineering are included in the grade band.",
                                researchConnection: "\"...[Crosscutting concepts] bridge disciplinary boundaries, having explanatory value throughout much of science and engineering. These crosscutting concepts were selected for their value across the sciences and in engineering. These concepts help provide students with an organizational framework for connecting knowledge from the various disciplines into a coherent and scientifically based view of the world. “(A Framework for K-12 Science Education, p. 83)\n\n\"Additionally, eight understandings with appropriate grade-level outcomes are included as extensions of the science and engineering practices and crosscutting concepts, not as a fourth dimension of standards. (NGSS Appendix H, p. 1)",
                                scoringDetails: [
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        ...
                                        "Describe how the materials make clear (to the students and/or teachers to support students) the connections of the three dimensions across learning sequences to connect prior, current, and future learning.\n- Connections should be explicit for students or for teachers to support students.\n- Connections should be related to different 'topics' and a larger grain size than learning opportunity to learning opportunity.\n- Connections are not continuations of learning. Do not identify opportunities for continuation of learning between two sequential learning opportunities."
                                    ]
                                },
                                clusterMeeting: {
                                    questions: [
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        "Describe how student tasks, related to explaining phenomena and/or solving problems, increase in sophistication across the grade-band.\n- This could include removal of supports or scaffolds over time, increase in complexity of tasks, students taking on more responsibility or independence as related to tasks, etc.\n- Tasks must be connected to a phenomena and/or problem.",
        ...
        },
        {
            ...
            totalPoints: 18,
            ratingThresholds: { meets: 12, partially: 7 },
            criterionSections: [
                {
                    id: 'criterion3_1',
                    name: 'Criterion 3.1: Teacher Supports (14 points)',
                    ...
                    items: [
                        {
                            ...
                            evidenceGuide: {
                                ...
                                researchConnection: null, // Not provided in PDF for this indicator
                                scoringDetails: [
                                ...
                                evidenceCollection: {
                                    locationsToReview: [ "Review the materials, both print and digital (if available), across the series." ],
                                    recordEvidence: [
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review the print and digital (if available) table of contents, pacing guides, scope and sequence, and other teacher materials."],
                                    recordEvidence: [
                        ...
                        {
                            id: '3d',
                            name: '3d. Materials provide strategies for informing all stakeholders, including students, parents, or caregivers about the program and suggestions for how they can help support student progress and achievement. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                            ...
                            isNonNegotiable: false,
                             evidenceGuide: {
                                ...
                                researchConnection: null,
                                scoringDetails: [
                                    { score: "N/A", text: "Scoring: Narrative Evidence Only. Note: No score is given for this indicator. Only qualitative evidence is provided." }
                                ],
                                evidenceCollection: {
                                    locationsToReview: ["Look at both print and digital (if available) student materials and teacher materials, including beginning sections of the entire course, unit, chapter, or lesson that contains overview sections, teacher instruction pages, or ancillary supports for a narrative explanation of the content in each topic, paying attention to key instruction that will inform others that may be assisting the student's progress."],
                                    recordEvidence: [
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review the materials across the series."],
                                    recordEvidence: [
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review assessments and corresponding assessment guidance across the series, including answer keys, rubrics, and other assessment scoring tools."],
                                    recordEvidence: [
                        ...
                        {
                            id: '3i',
                            name: '3i. Materials designated for each grade are feasible and flexible for one school year. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review the materials across the series, including the table of contents, any pacing guides, and scope and sequence provided by the publisher."],
                                    recordEvidence: [
                ...
                {
                    id: 'criterion3_2',
                    name: 'Criterion 3.2: Student Supports (4 points)',
                    ...
                    items: [
                        {
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review teacher and student materials across the series."],
                                    recordEvidence: [
                        ...
                        },
                        {
                            ...
                            evidenceGuide: {
                                ...
                                researchConnection: "\"Arguably, the most pressing challenge facing U.S. education is to provide all students with a fair opportunity to learn.\" (A Framework for K-12 Science Education, p. 282)\n\n\"Science and engineering practices can actually serve as productive entry points for students from diverse communities...” (A Framework for K-12 Science Education, p. 283)\n\n\"When people enter into the practices of science or engineering, they do not leave their cultural worldviews at the door. Instruction that fails to recognize this reality can adversely affect student engagement in science... Everyday experience provides a rich base of knowledge and experience to support conceptual changes in science. Students bring cultural funds of knowledge that can be leveraged, combined with other concepts, and transformed into scientific concepts over time.\" (A Framework for K-12 Science Education, p. 284)",
                                scoringDetails: [
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review the student materials across the series."],
                                    recordEvidence: [
                        ...
                        {
                            id: '3l',
                            name: '3l. Materials provide varied approaches to learning tasks over time and variety in how students are expected to demonstrate their learning with opportunities for students to monitor their learning. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                                ...
                                'Materials leverage the use of a variety of formats over time to deepen student understanding and ability to explain and apply science ideas.',
                        ...
                        {
                            id: '3m',
                            name: '3m. Materials provide opportunities for teachers to use a variety of grouping strategies. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                        ...
                        {
                            id: '3n',
                            name: '3n. Assessments offer accommodations that allow students to demonstrate their knowledge and skills without changing the content of the assessment. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review assessments and corresponding assessment guidance across the series."],
                                    recordEvidence: [
                        ...
                        {
                            id: '3o',
                            name: '3o. Materials provide a range of representation of people and include detailed instructions and support for educators to effectively incorporate and draw upon students\' different cultural, social, and community backgrounds to enrich learning experiences. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                            ...
                            evidenceGuide: {
                                ...
                                purpose: "In 2022, EdReports conducted a landscape analysis of 15 different resources to help educators understand trends and best practices in culturally responsive education, highlighting ongoing efforts and areas for improvement in providing adequate support for culturally relevant instruction. This indicator examines whether materials reflect diverse identities, connect learning to real-world and culturally relevant contexts, and promote student engagement through authentic representation, high expectations, and community involvement. In doing so, the indicator supports communities in engaging in deep discourse and aligning educational practices with their local contexts.",
                                researchConnection: null,
                                scoringDetails: [
                                    { score: "N/A", text: "Scoring: Narrative Evidence Only. Note: No score is given for this indicator. Only qualitative evidence is provided." }
                                ],
                                evidenceCollection: {
                                    ...
                                    recordEvidence: [
                                        ...
                                        "Describe images and representations that depict students actively participating in learning experiences that are connected to real-world contexts.\n- These should include diverse identities of students collaborating, problem-solving, or exploring concepts in ways that highlight their cultural and personal identities. Explicitly note if these images show students of different backgrounds in leadership roles, working together in a variety of group settings, and utilizing culturally relevant tools or methods.",
                        ...
                        {
                            id: '3p',
                            name: '3p. Materials provide supports for different reading levels to ensure accessibility for students. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                        ...
                        {
                            id: '3q',
                            name: '3q. This is not an assessed standard in Science.',
                            scoringOptions: [],
                            scoringCriteria: [],
                            isNarrativeOnly: true,
                            isNonNegotiable: false,
                            evidenceGuide: {
                                ...
                                guidingQuestion: null, purpose: null, researchConnection: null,
                                scoringDetails: [],
                                evidenceCollection: { locationsToReview: [], recordEvidence: [] },
                                clusterMeeting: { questions: [] }
                            }
                        }
                    ]
                },
                {
                    id: 'criterion3_3',
                    name: 'Criterion 3.3: Intentional Design (Narrative Evidence Only)',
                    ...
                    items: [
                        {
                            id: '3r',
                            name: '3r. Materials integrate technology such as interactive tools, virtual manipulatives/objects, and/or dynamic software in ways that engage students in the grade-level/series standards, when applicable. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                                'Digital technology and interactive tools, such as data collection tools and/or modeling tools are available to students.',
                                'Digital tools support student engagement in the three dimensions of science.',
                        ...
                        {
                            id: '3s',
                            name: '3s. Materials include or reference digital technology that provides opportunities for teachers and/or students to collaborate with each other, when applicable. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                        ...
                        {
                            id: '3t',
                            name: '3t. The visual design (whether in print or digital) supports students in engaging thoughtfully with the subject, and is neither distracting nor chaotic. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                        ...
                        {
                            id: '3u',
                            name: '3u. Materials provide teacher guidance for the use of embedded technology to support and enhance student learning, when applicable. (Narrative Evidence Only)',
                            scoringOptions: [],
                            scoringCriteria: [
                            ...
                            evidenceGuide: {
                                ...
                                evidenceCollection: {
                                    locationsToReview: ["Review teacher materials across the series."],
                                    recordEvidence: [
    ...
    finalRatingLogic: [
        {
            condition: (g, scores) => {
                ...
                if (scores['gateway2.criterion2_1.2d'] === 0) return true;
                if (scores['gateway2.criterion2_1.2e'] === 0) return true;
                // Check if Gateway 1 or Gateway 2 Does Not Meet
                return g.gateway1 === 'Does Not Meet Expectations' || g.gateway2 === 'Does Not Meet Expectations';
            },
            result: 'Does Not Meet Expectations'
        },
        {
            condition: (g) => g.gateway1 === 'Meets Expectations' && g.gateway2 === 'Meets Expectations' && g.gateway3 === 'Meets Expectations',
            result: 'Meets Expectations'
        },
        {
            condition: (g) => g.gateway1 === 'Meets Expectations' && g.gateway2 === 'Meets Expectations' && (!g.gateway3 || g.gateway3 === 'Not Rated' || g.gateway3 === 'Partially Meets Expectations'),
...
console.log("NGSS 6-8 Science Rubric Loaded:", window.rubrics['science-68']);