# Gemma 4 Complete Reference Guide

> Downloaded from official Google AI documentation: https://ai.google.dev/gemma/docs

## Documentation Index

| File | Topic |
|---|---|
| [01-prompt-formatting.md](01-prompt-formatting.md) | Gemma 4 control tokens, turn structure, tool/thinking tokens |
| [02-model-card.md](02-model-card.md) | Model sizes, memory requirements, benchmarks, best practices |
| [03-thinking-mode.md](03-thinking-mode.md) | Enabling thinking, parsing output, multi-turn management |
| [04-function-calling.md](04-function-calling.md) | Tool definitions, 3-stage cycle, thinking + tools |
| [05-image-understanding.md](05-image-understanding.md) | Vision tasks, object detection, OCR, token budget |
| [06-audio-understanding.md](06-audio-understanding.md) | ASR, AST, audio format requirements (E2B/E4B only) |
| [07-video-understanding.md](07-video-understanding.md) | Frame-based video processing, token budgets |
| [08-web-deployment-mediapipe.md](08-web-deployment-mediapipe.md) | MediaPipe LLM API, WebGPU, CDN setup, LoRA |
| [09-hf-to-mediapipe-conversion.md](09-hf-to-mediapipe-conversion.md) | HF Safetensors → .task conversion for Android/iOS |
| [10-legacy-prompt-structure.md](10-legacy-prompt-structure.md) | Legacy format for Gemma 1, 2, 3 |
...
```
<|turn>system
<|think|>[other instructions]<turn|>
```
- `<|channel>thought` ... `<channel|>` = internal reasoning block
- Strip thoughts between turns (NOT during tool calls within same turn)

### Function Calling Tokens
| Token | Purpose |
|---|---|
| `<\|tool>...<tool\|>` | Tool declaration (in system turn) |
| `<\|tool_call>...<tool_call\|>` | Model requests tool execution |
| `<\|tool_response>...<tool_response\|>` | App injects tool result |
| `<\|"\|>` | String value delimiter inside tool blocks |
...
## Quick Reference: Sampling Parameters (Recommended)
...
| Model | VRAM (BF16) | VRAM (Q4) | Context | Audio |
|---|---|---|---|---|
| E2B | 9.6 GB | 3.2 GB | 128K | ✅ |
| E4B | 15 GB | 5 GB | 128K | ✅ |
| 31B | 58.3 GB | 17.4 GB | 256K | ❌ |
| 26B A4B | 48 GB | 15.6 GB | 256K | ❌ |

## Quick Reference: Image Token Budget

| Budget | Best For |
|---|---|
| 70–140 | Video frames, fast classification |
| 280 | General image understanding |
| 560 | Object detection |
| 1120 | OCR, document parsing, fine-grained detail |

---

# Gemma 4 Prompt Formatting

Starting with Gemma 4, new control tokens were introduced. For Gemma 3 and lower,
see [10-legacy-prompt-structure.md](10-legacy-prompt-structure.md).
