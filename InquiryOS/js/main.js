...
window.updatePhenomenon = dashboard.updatePhenomenon;
...
window.toggleNotesFeed = viewer.toggleNotesFeed;
window.focusNote = viewer.focusNote;
window.toggleStickerPalette = viewer.toggleStickerPalette;
window.setViewerSticker = viewer.setViewerSticker;
