...
function renderDiscussionPosts(colors) {
    ...
    if (posts.length === 0) return `<div class="h-full flex flex-col items-center justify-center text-center opacity-30 grayscale py-20"><div class="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mb-6 shadow-inner border border-white"><span class="iconify text-5xl" data-icon="mdi:forum-outline"></span></div><h3 class="text-xl font-black text-gray-400 uppercase">Discussion Empty</h3><p class="text-xs font-medium text-gray-400 mt-1 max-w-xs">Be the first to share a claim!</p></div>`;
